<?php $__env->startSection('title', 'Tableau de bord - Garage Backoffice'); ?>
<?php $__env->startSection('page-title', 'Dashboard'); ?>
<?php $__env->startSection('page-description', "Vue d'ensemble de l'activité du garage"); ?>
...
<div id="stats" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
    <div class="glass-card rounded-2xl p-6 border-l-4 border-l-[#54ACBF]" style="background: linear-gradient(135deg, rgba(84, 172, 191, 0.15) 0%, rgba(84, 172, 191, 0.25) 100%);">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-3xl font-bold text-white"><?php echo e($totalReparations); ?></h3>
            </div>
    ...
    <div class="glass-card rounded-2xl p-6 border-l-4 border-l-[#54ACBF]" style="background: linear-gradient(135deg, rgba(84, 172, 191, 0.15) 0%, rgba(84, 172, 191, 0.25) 100%);">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-3xl font-bold text-white"><?php echo e($clientsCount); ?></h3>
            </div>
            <div class="p-3 rounded-xl" style="background: rgba(84, 172, 191, 0.2); color: #54ACBF;">
    ...
    <div class="glass-card rounded-2xl p-6 border-l-4 border-l-[#54ACBF]" style="background: linear-gradient(135deg, rgba(84, 172, 191, 0.15) 0%, rgba(84, 172, 191, 0.25) 100%);">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-3xl font-bold text-white"><?php echo e(number_format($totalRevenue, 0, ',', ' ')); ?> <span class="text-lg">Ar</span></h3>
            </div>
            <div class="p-3 rounded-xl" style="background: rgba(84, 172, 191, 0.2); color: #54ACBF;">
    ...
    <div class="glass-card rounded-2xl p-6 border-l-4 border-l-[#54ACBF]" style="background: linear-gradient(135deg, rgba(84, 172, 191, 0.15) 0%, rgba(84, 172, 191, 0.25) 100%);">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-3xl font-bold text-white"><?php echo e($reparationsEnCours->count()); ?>/3</h3>
            </div>
            <div class="p-3 rounded-xl" style="background: rgba(84, 172, 191, 0.2); color: #54ACBF;">
    ...
    <div class="glass-card rounded-2xl p-6 border-l-4 border-l-[#54ACBF]" style="background: linear-gradient(135deg, rgba(84, 172, 191, 0.15) 0%, rgba(84, 172, 191, 0.25) 100%);">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-3xl font-bold text-white"><?php echo e($reparationsAujourdHui); ?></h3>
            </div>
            <div class="p-3 rounded-xl" style="background: rgba(84, 172, 191, 0.2); color: #54ACBF;">
    ...
    <div class="glass-card rounded-2xl p-6 border-l-4 border-l-[#54ACBF]" style="background: linear-gradient(135deg, rgba(84, 172, 191, 0.15) 0%, rgba(84, 172, 191, 0.25) 100%);">
        <div class="flex justify-between items-start">
            <div>
                ...
                <h3 class="text-3xl font-bold text-white"><?php echo e(number_format($totalPending, 0, ',', ' ')); ?> <span class="text-lg">Ar</span></h3>
            </div>
            <div class="p-3 rounded-xl" style="background: rgba(84, 172, 191, 0.2); color: #54ACBF;">
        ...
        <div class="glass-card rounded-2xl overflow-hidden">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <?php for($i = 1; $i <= 3; $i++): ?>
                        <?php $repair = $reparationsEnCours->where('slot', $i)->first(); ?>
                        <div class="relative rounded-xl p-5 border" style="border-color: <?php echo e($repair ? 'rgba(84, 172, 191, 0.3)' : 'rgb(55, 65, 81)'); ?>; background-color: <?php echo e($repair ? 'rgba(84, 172, 191, 0.05)' : 'rgba(31, 41, 55, 0.2)'); ?>;">
                            <div class="absolute top-4 right-4">
                                <span class="px-2 py-1 rounded-md text-[10px] font-bold tracking-tighter uppercase" style="background-color: <?php echo e($repair ? '#54ACBF' : 'rgb(55, 65, 81)'); ?>; color: white;">
                                    SLOT <?php echo e($i); ?>
                            ...
                            <?php if($repair): ?>
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="text-white font-bold leading-tight"><?php echo e($repair->client->nom); ?></h4>
                                        <p class="text-gray-400 text-xs mt-1"><?php echo e($repair->client->voiture_marque); ?> <?php echo e($repair->client->voiture_modele); ?> • <span class="font-mono" style="color: #A7EBF2;"><?php echo e($repair->client->voiture_immatriculation); ?></span></p>
                                        <div class="mt-4 pt-4 border-t border-gray-700/50">
                                            <p class="text-[10px] text-gray-500 uppercase tracking-wider">Intervention</p>
                                            <p class="text-sm text-gray-200 mt-1"><?php echo e($repair->intervention->nom); ?></p>
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
        ...
        <div class="glass-card rounded-2xl p-6">
            <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <select id="monthSelector" onchange="updateTemporalStats()" class="bg-gray-800 border-0 text-white text-xs rounded-lg px-3 py-2 outline-none focus:ring-2" style="focus:ring-color: #54ACBF;">
                        <?php $__currentLoopData = ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Jun', 'Jul', 'Aoû', 'Sep', 'Oct', 'Nov', 'Déc']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($index + 1); ?>" <?php echo e($selectedMonth == ($index + 1) ? 'selected' : ''); ?>><?php echo e($month); ?></option>
                    ...
                    <select id="weekSelector" onchange="updateTemporalStats()" class="bg-gray-800 border-0 text-white text-xs rounded-lg px-3 py-2 outline-none focus:ring-2" style="focus:ring-color: #54ACBF;">
                        <?php for($w = 1; $w <= 52; $w++): ?>
                            <option value="<?php echo e($w); ?>" <?php echo e($selectedWeek == $w ? 'selected' : ''); ?>>Semaine <?php echo e($w); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <div class="p-4 rounded-xl" style="background: rgba(84, 172, 191, 0.15); backdrop-filter: blur(10px); border: 2px solid rgba(84, 172, 191, 0.5); box-shadow: 0 4px 15px rgba(84, 172, 191, 0.1);">
                    ...
                    <p class="text-white text-xl font-bold"><?php echo e(number_format($revenuesYear, 0, ',', ' ')); ?> <span class="text-sm font-normal text-gray-500">Ar</span></p>
                    <p style="color: #54ACBF;" class="text-xs mt-1"><?php echo e($repairsYear); ?> interventions</p>
                </div>
                <div class="p-4 rounded-xl" style="background: rgba(38, 101, 140, 0.15); backdrop-filter: blur(10px); border: 2px solid rgba(38, 101, 140, 0.5); box-shadow: 0 4px 15px rgba(38, 101, 140, 0.1);">
                    ...
                    <p class="text-white text-xl font-bold"><?php echo e(number_format($revenuesMonth, 0, ',', ' ')); ?> <span class="text-sm font-normal text-gray-500">Ar</span></p>
                    <p style="color: #26658C;" class="text-xs mt-1"><?php echo e($repairsMonth); ?> interventions</p>
                </div>
                <div class="p-4 rounded-xl" style="background: rgba(167, 235, 242, 0.15); backdrop-filter: blur(10px); border: 2px solid rgba(167, 235, 242, 0.5); box-shadow: 0 4px 15px rgba(167, 235, 242, 0.1);">
                    ...
                    <p class="text-white text-xl font-bold"><?php echo e(number_format($revenuesWeek, 0, ',', ' ')); ?> <span class="text-sm font-normal text-gray-500">Ar</span></p>
                    <p style="color: #A7EBF2;" class="text-xs mt-1"><?php echo e($repairsWeek); ?> interventions</p>
                </div>
            </div>

            <!-- Tableau Statistiques Récapitulatif -->
            <div class="mt-8 overflow-hidden rounded-xl border border-gray-800">
                <table class="min-w-full divide-y divide-gray-800">
                    <thead class="bg-gray-800/50">
                        <tr>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-bold text-gray-400 uppercase tracking-wider">Indicateur Statistique</th>
                            <th scope="col" class="px-6 py-3 text-right text-xs font-bold text-gray-400 uppercase tracking-wider">Valeur Actuelle</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-800 bg-transparent">
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">Montant total des interventions (CA)</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-bold text-[#54ACBF]"><?php echo e(number_format($totalRevenue, 0, ',', ' ')); ?> Ar</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">Nombre total de clients</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-bold text-white"><?php echo e($clientsCount); ?> clients</td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">Réparations totales effectuées</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-right font-bold text-white"><?php echo e($totalReparations); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="lg:col-span-4 space-y-8">
        ...
        <div class="glass-card rounded-2xl overflow-hidden">
            ...
            <div class="p-4 max-h-[400px] overflow-y-auto custom-scrollbar">
                <?php $__empty_1 = true; $__currentLoopData = $reparationsTerminees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reparation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 rounded-xl bg-gray-800/20 border border-gray-700/50 mb-3 hover:bg-gray-800/40 transition group">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-white font-medium text-sm"><?php echo e($reparation->client->nom); ?></p>
                                <p class="text-gray-500 text-xs mt-1"><?php echo e($reparation->intervention->nom); ?></p>
                            </div>
                            <span class="text-white font-bold text-sm"><?php echo e(number_format($reparation->montant_total, 0, ',', ' ')); ?> <span class="text-[10px] text-gray-400">Ar</span></span>
                        </div>
                    </div>
        ...
        <div class="glass-card rounded-2xl overflow-hidden">
            ...
            <div class="p-4 max-h-[400px] overflow-y-auto custom-scrollbar">
                <?php $__empty_1 = true; $__currentLoopData = $reparationsPayees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reparation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center space-x-4 mb-4 last:mb-0 p-3 rounded-lg hover:bg-white/5 transition">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-white truncate"><?php echo e($reparation->client->nom); ?></p>
                            <p class="text-xs text-gray-500"><?php echo e($reparation->updated_at->diffForHumans()); ?></p>
                        </div>
                        <div class="text-right">
                            <p class="text-sm font-bold" style="color: #A7EBF2;">+<?php echo e(number_format($reparation->montant_total, 0, ',', ' ')); ?></p>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        ...
        <div class="glass-card rounded-2xl p-6">
            ...
            <div class="space-y-4">
                <?php $__currentLoopData = $interventionsPopulaires; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $intervention): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center">
                        <div class="flex-1">
                            <div class="flex justify-between mb-1">
                                <span class="text-gray-300 text-xs"><?php echo e($intervention->intervention->nom); ?></span>
                                <span class="text-white text-xs font-bold"><?php echo e($intervention->count); ?></span>
                            </div>
                            <div class="w-full bg-gray-800 rounded-full h-1.5 overflow-hidden">
                                ...
                                ?>
                                <div class="h-1.5 rounded-full" style="width: <?php echo e($percentage); ?>%; background: linear-gradient(90deg, #54ACBF, #26658C, #A7EBF2);"></div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
console.log('Dashboard data:', {
    revenue: [<?php echo e($totalRevenue); ?>, <?php echo e($totalPending); ?>, <?php echo e($reparationsEnCours->sum('montant_total')); ?>],
    types: <?php echo json_encode($interventionsPopulaires->pluck('intervention.nom')); ?>,
    counts: <?php echo json_encode($interventionsPopulaires->pluck('count')); ?>
...
if (revenueCtx) {
    new Chart(revenueCtx, {
        ...
        data: {
            ...
            datasets: [{
                data: [<?php echo e($totalRevenue); ?>, <?php echo e($totalPending); ?>, <?php echo e($reparationsEnCours->sum('montant_total')); ?>],
...
if (typeCtx) {
    new Chart(typeCtx, {
        type: 'doughnut',
        data: {
            labels: <?php echo json_encode($interventionsPopulaires->pluck('intervention.nom')); ?>,
            datasets: [{
                data: <?php echo json_encode($interventionsPopulaires->pluck('count')); ?>,
...
function exportToPDF() {
    try {
        ...
        const data = [
            ['Indicateur', 'Valeur'],
            ['Réparations Totales', '<?php echo e($totalReparations); ?>'],
            ['Chiffre d\'Affaires', '<?php echo e(number_format($totalRevenue, 0, ",", " ")); ?> Ar'],
            ['En attente de paiement', '<?php echo e(number_format($totalPending, 0, ",", " ")); ?> Ar'],
            ['Trafic Clients', '<?php echo e($clientsCount); ?>']
        ];
...
function exportToExcel() {
    try {
        ...
        const data = [
            ['Dashboard Stats', ''],
            ['Total Réparations', '<?php echo e($totalReparations); ?>'],
            ['CA Réglé', '<?php echo e($totalRevenue); ?>'],
            ['CA Attendu', '<?php echo e($totalPending); ?>'],
            ['Clients', '<?php echo e($clientsCount); ?>']
        ];
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/resources/views/dashboard.blade.php ENDPATH**/ ?>