...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Garage Backoffice'); ?> - Administration</title>
        ...
        <nav class="mt-6">
            <div class="px-4">
                ...
                <a href="<?php echo e(route('dashboard')); ?>"
                    class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 <?php echo e(request()->routeIs('dashboard') ? 'active' : 'hover:bg-gray-800'); ?>">
                ...
                <a href="<?php echo e(route('interventions.index')); ?>"
                    class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 <?php echo e(request()->routeIs('interventions.*') ? 'active' : 'hover:bg-gray-800'); ?>">
                    <i class="fas fa-tools w-5"></i>
                    <span>Interventions</span>
                </a>

                <!-- Réparations -->
                <a href="<?php echo e(route('admin.repairs.index')); ?>"
                    class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded-lg mb-2 <?php echo e(request()->routeIs('admin.repairs.*') ? 'active' : 'hover:bg-gray-800'); ?>">
                    <i class="fas fa-car-wrench w-5"></i>
                    <span>Réparations</span>
                </a>

                <!-- Statistiques -->
                <a href="<?php echo e(route('dashboard')); ?>#stats"
        ...
        <header style="background-color: #1a2332; border-bottom: 1px solid #2d3f54;">
            <div class="px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold" style="color: #ffffff;"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                        <p class="text-sm" style="color: #a0a0a0;"><?php echo $__env->yieldContent('page-description', 'Gestion du garage'); ?></p>
                    </div>
